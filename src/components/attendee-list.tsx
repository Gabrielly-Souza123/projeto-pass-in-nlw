                    ...
                    {Array.from({ length: 8}).map((_, i) =>{
                        return(                    
                            <tr key={i} className='border-b border-white/10 hover:bg-white/5'>
                                ...
                                <td className='py-3 px-4 text-sm  text-zinc-300'>12346</td>
                                <td className='py-3 px-4 text-sm text-zinc-300'>
                                    <div className='flex flex-col gap-1'>
                                        <span className='font-semibold text-white'>gabrielly</span>
                                        <span>gabrielly@email</span>
                                    </div>
                                </td>
                        ...
                        <div className='inline-flex items-center gap-8'>
                            <span>Página 1 de 23</span>
                                ...
                                <div className='flex gap-1.5'>
                                    <button className='bg-white/10 border border-white/10 rounded-md px-1.5 py-1.5'>
